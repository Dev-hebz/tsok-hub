    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-blue-950">
      ...
      >
        <div className="container mx-auto px-4 py-8 text-center text-blue-200">
          <p className="mb-2">© 2024 TSOK - Teachers Specialists Organization Kuwait</p>
          <p className="text-sm">Developed by <span className="text-yellow-400 font-semibold">Godmisoft</span></p>
        </div>
      </motion.footer>
    </div>
  );
